...
//     I have commented the word "Test" at the start of each test to be assessed.  
//     A case-sensitive search will help you cycle through them
...
describe("controller", function () {
  ...
  describe("routing", function () {
    ...
    it("should show active entries", function () {
      ...
      var todo1 = { title: "my first todo", completed: false };
    ...
    it("should show completed entries", function () {
      ...
      var todo1 = { title: "my first todo", completed: true };
  ...
  describe("toggle all", function () {
    it("should toggle all todos to completed", function () {
      // Test
      var todo1 = { title: "my first todo", id: 22, completed: false };
      setUpModel([todo1]);
      subject.setView("");
  ...
  describe("element removal", function () {
    it("should remove an entry from the model", function () {
      ...
      var todo = { id: 22, title: "my todo", completed: true };
      setUpModel([todo]);
      subject.setView("");
      view.trigger("itemRemove", { id: 22 });
